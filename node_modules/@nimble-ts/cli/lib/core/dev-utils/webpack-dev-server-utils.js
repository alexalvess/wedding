...
const detect_port_alt_1 = tslib_1.__importDefault(require("detect-port-alt"));
const is_root_1 = tslib_1.__importDefault(require("is-root"));
const prompts_1 = tslib_1.__importDefault(require("prompts"));
const clear_console_1 = require("./clear-console");
const format_webpack_msgs_1 = require("./format-webpack-msgs");
const process_for_port_1 = require("./process-for-port");
const fork_ts_checker_webpack_plugin_1 = require("./fork-ts-checker-webpack-plugin");
...
function createCompiler({ appName, config, urls, useYarn, useTypeScript, webpack, }) {
    ...
    compiler.hooks.done.tap('done', (stats) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        if (isInteractive) {
            (0, clear_console_1.clearConsole)();
        }
        ...
        const messages = (0, format_webpack_msgs_1.formatWebpackMessages)(statsData);
    ...
    if (isSmokeTest) {
        compiler.hooks.failed.tap('smokeTest', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield tsMessagesPromise;
            process.exit(1);
        }));
        compiler.hooks.done.tap('smokeTest', (stats) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield tsMessagesPromise;
...
function resolveLoopback(proxy) {
    const o = url_1.default.parse(proxy);
    o.host = undefined;
...
function prepareProxy(proxy, appPublicFolder, servedPathname) {
    ...
    function mayProxy(pathname) {
        const maybePublicPath = path_1.default.resolve(appPublicFolder, pathname.replace(new RegExp('^' + servedPathname), ''));
        const isPublicFileRequest = fs_1.default.existsSync(maybePublicPath);
...
function choosePort(host, defaultPort) {
    return (0, detect_port_alt_1.default)(defaultPort, host).then(port => new Promise(resolve => {
        ...
        if (isInteractive) {
            (0, clear_console_1.clearConsole)();
            const existingProcess = (0, process_for_port_1.getProcessForPort)(defaultPort);
            const question = {
                type: 'confirm',
