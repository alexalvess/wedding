...
const directive_generate_template_1 = require("./directive-generate-template");
const base_generate_1 = require("../base-generate");
let DirectiveGenerate = class DirectiveGenerate extends base_generate_1.BaseGenerate {
    constructor(logger) {
        super();
        this.logger = logger;
    }
    execute() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isValid(name)) {
                ...
                yield this.startCreateDirective();
            }
            else
                yield this.execute();
        });
