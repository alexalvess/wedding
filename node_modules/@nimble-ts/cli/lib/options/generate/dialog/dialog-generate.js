...
const dialog_generate_template_1 = require("./dialog-generate-template");
const base_generate_1 = require("../base-generate");
let DialogGenerate = class DialogGenerate extends base_generate_1.BaseGenerate {
    constructor(logger) {
        super();
        this.logger = logger;
    }
