...
const service_generate_template_1 = require("./service-generate-template");
const base_generate_1 = require("../base-generate");
let ServiceGenerate = class ServiceGenerate extends base_generate_1.BaseGenerate {
    constructor(logger) {
        super();
        this.logger = logger;
    }
